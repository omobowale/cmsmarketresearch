<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a href="/others">{{ __('Website Names >> ') }} </a> <small class="text-blue-600">New Website Name</small>
        </h2>
    </x-slot>

    <x-slot name="slot">
      <form action="/website-names" method="POST">
        @csrf
                ...
                <div class="sm:w-full mx-auto">
                  <div class="flex items-center space-x-5">
                    ...
                    <div class="block pl-2 font-semibold text-xl text-gray-700">
                      <h2 class="leading-relaxed mx-auto">Add a new website name</h2>
