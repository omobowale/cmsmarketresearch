<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <span class="mr-10 py-8"><a href="/others">{{ __('Others') }}</a></span>
            </h2>
        </div>
    </x-slot>
    ...
    <x-slot name="slot">
        <div class="m-auto px-4">
            ...
            <h3 class="text-center general-bg-color font-bold text-2xl p-4 mb-3 text-white">{{'Logos'}} <a href="/logos/create"><span title="Add a new logo" class="bg-white ml-10 px-4 py-2 general-text-color font-bold cursor-pointer rounded-full h-12 w-12">+</span></a></h3>
            @if(count($logos) > 0)
            ...
            <h3 class="text-center general-bg-color font-bold text-2xl p-4 mb-3 mt-5 text-white">{{'Website Names'}} <a href="/website-names/create"><span title="Add a new website name" class="bg-white ml-10 px-4 py-2 general-text-color font-bold cursor-pointer rounded-full h-12 w-12">+</span></a></h3>
            @if(count($webnames) > 0)
