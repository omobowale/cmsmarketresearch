<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a href="/others">{{ __('Contact >> ') }} </a> <small class="text-blue-600">Create Contact</small>
        </h2>
    </x-slot>

    <x-slot name="slot">
      <form action="/contact-manager" method="POST">
        @csrf
                ...
                <div class="sm:w-full mx-auto">
                  <div class="flex items-center space-x-5">
                    ...
                    <div class="block pl-2 font-semibold text-xl text-gray-700">
                      <h2 class="leading-relaxed mx-auto">Add a contact</h2>
                  ...
                  <div class="divide-y divide-gray-200">
                    <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                      <div class="flex flex-col">
                        ...
                        <textarea name="address" id="address" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Enter address">{{old('address') ?? ''}}</textarea>
                        @error('address')
                      ...
                      <div class="flex flex-col">
                        ...
                        <input name="phone" id="phone" type="tel" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Enter phone number" value="{{old('phone') ?? ''}}">
                        @error('phone')
                          <div class="text-sm text-red-500">{{ $message }}</div>
                        @enderror
                      </div>
